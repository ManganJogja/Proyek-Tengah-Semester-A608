"""
Django settings for mangan_jogja project.
...
SECRET_KEY = 'django-insecure-8x%)-fpg+&@ch(79j!dshtc8l_2r#1pqb715uaeal9mmi1jvp('
...
WSGI_APPLICATION = 'mangan_jogja.wsgi.application'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'reserve.views': {  # Adjust this to match your app structure
            'handlers': ['console'],
            'level': 'DEBUG',
        }
    }
